...
from .receive import OpenTTDProtocolStunReceive

log = logging.getLogger(__name__)


class OpenTTDProtocolTCPStun(asyncio.Protocol, OpenTTDProtocolStunReceive):
...
@click.option(
    "--stun-proxy-protocol",
    help="Enable Proxy Protocol (v1) for STUN server, and expect all incoming package to have this header.",
    is_flag=True,
)
def click_stun_proxy_protocol(stun_proxy_protocol):
    OpenTTDProtocolTCPStun.proxy_protocol = stun_proxy_protocol
